...
/*   Updated: 2023/10/13 20:55:06 by fra           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
class brt::forms::RobotomyRequestForm : public brt::AForm
{
	public:
		RobotomyRequestForm( void ) throw() :
			brt::AForm("Robotomy request", 72, 45) , _target("no_target") {}
		RobotomyRequestForm( std::string const& target) throw() :
			brt::AForm("Robotomy request", 72, 45) , _target(target){}
		...
		static brt::AForm*	newInstance( std::string const& );
