...
/*   Updated: 2023/10/13 20:48:28 by fra           ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
brt::AForm*	brt::forms::RobotomyRequestForm::RobotomyRequestForm::newInstance( std::string const& target)
{
	return (new brt::forms::RobotomyRequestForm(target));
}